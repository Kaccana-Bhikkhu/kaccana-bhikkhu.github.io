    ...
    for tag,tagInfo in gDatabase["tag"].items():
        ...
        if len(relevantExcerpts) >= gOptions.minSubsearchExcerpts:
            ...
            filterMenu = [
                ...
                FilteredExcerptsMenuItem(relevantExcerpts,Filter.Tag(tag,category="Readings"),formatter,pageInfo,"Readings","reading"),
                FilteredExcerptsMenuItem(relevantExcerpts,Filter.Tag(tag,kind={"Sutta","Vinaya","Commentary"}),formatter,pageInfo,"Texts","text"),
                FilteredExcerptsMenuItem(relevantExcerpts,Filter.Tag(tag,kind={"Reference"}),formatter,pageInfo,"References","reference")
            ]
